...
OBJECT                       = SPICE_KERNEL
  ...
  KERNEL_TYPE                = FRAMES
  DESCRIPTION                = "DAWN SPICE FK file providing the complete
set of frame definitions for the DAWN spacecraft, its structures and science
